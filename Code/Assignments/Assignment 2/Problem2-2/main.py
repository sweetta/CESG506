...
plt.subplot(2, 1, 1)
plt.plot(U5u, G, label="$U_{5u}$", marker='.')
plt.plot(U5v, G, label="$U_{5v}$", marker='.')
plt.plot(U5w, G, label="$U_{5w}$", marker='.')
plt.xlim(-0.1, 1.1)
plt.ylabel('$\gamma$')
...
plt.subplot(2, 1, 2)
plt.plot(U6u, G, label="$U_{6u}$", marker='.')
plt.plot(U6v, G, label="$U_{6v}$", marker='.')
plt.plot(U6w, G, label="$U_{6w}$", marker='.')
...
plt.subplot(2, 2, 1)
plt.plot(U5u, U5w, label="$U_5$ xz planar view", marker='.')
...
plt.subplot(2, 2, 2)
plt.plot(U5v, U5w, label="$U_5$ yz planar view", marker='.')
plt.gca().invert_yaxis()
plt.xlabel('$U_{5y}$ [m]')
plt.ylabel('$U_{5z}$ [m]')
plt.legend(loc='best', ncol=1, framealpha=1)
...
plt.subplot(2, 2, 3)
plt.plot(U6u, U6w, label="$U_6$ xz planar view", marker='.')
plt.gca().invert_yaxis()
plt.xlabel('$U_{6x}$ [m]')
plt.ylabel('$U_{6z}$ [m]')
plt.legend(loc='best', ncol=1, framealpha=1)
...
plt.subplot(2, 2, 4)
plt.plot(U6v, U6w, label="$U_6$ yz planar view", marker='.')
plt.gca().invert_yaxis()
plt.xlabel('$U_{6y}$ [m]')
plt.ylabel('$U_{6z}$ [m]')
plt.legend(loc='best', ncol=1, framealpha=1)
